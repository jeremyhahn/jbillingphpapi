...
/* TODO: Customize this exception handler to integrate into your application and remove this comment! - Enjoy :)
      public function JbillingAPIException( $message, $code ) {

             echo "<strong>JbillingAPIException: <strong><hr>Code: " . $code . "<br>Message: ". $message;
             exit;
      }
*/
}
