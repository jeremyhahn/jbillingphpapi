...
class RateOrderTest extends BaseTest {
	  ...
	  public function test() {
             ...
             try {
	  		 	   $actual = $this->api->rateOrder( $MockOrderWS->getObject() );
			       PHPUnit_Framework_Assert::assertEquals( ITEM_ID, $actual->return->orderLines->itemId, 'Couldnt get rateOrder' );
			 }
