...
class GetLatestOrderTest extends BaseTest {
	  ...
	  public function test() {
             ...
             try {
	  		 	   $actual = $this->api->getLatestOrder( USER_ID );
			       PHPUnit_Framework_Assert::assertType( 'OrderWS', $actual->return, 'Couldnt get latest order' );
			 }
